        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Stations_Capacity", "[Capacity] > 0");
                    table.CheckConstraint("CK_Stations_CurrentCount", "[CurrentCount] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatePerMinVnd = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                name: "ForeignTouristDetails",
                columns: table => new
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    PassportEnc = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Nationality = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForeignTouristDetails", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_ForeignTouristDetails_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocalCommuterDetails", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_LocalCommuterDetails_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DecommissionReason = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Stations_HomeStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    RatePerMinSnapshot = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    DurationMinutes = table.Column<int>(type: "int", nullable: true),
                    BaseFare = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                    Discount = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                    TotalFare = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_EntityName_EntityId_LoggedAt",
                table: "AuditLogs",
                columns: new[] { "EntityName", "EntityId", "LoggedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocalCommuterDetails_NationalId",
                table: "LocalCommuterDetails",
                column: "NationalId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_Status_Active",
                table: "Rentals",
                column: "Status",
                filter: "[Status] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_UserId_StartTime",
                table: "Rentals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stations_OccupancyCalc",
                table: "Stations",
                columns: new[] { "IsActive", "IsDeleted" })
                .Annotation("SqlServer:Include", new[] { "Capacity", "CurrentCount" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_PaidAt_Method",
                table: "Transactions",
                columns: new[] { "PaidAt", "PaymentMethod" })
                .Annotation("SqlServer:Include", new[] { "Amount", "Discount" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_HomeStationId",
                table: "Vehicles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_Status_HomeStation",
                table: "Vehicles",
                columns: new[] { "Status", "HomeStationId" },
                filter: "[IsDeleted] = 0");
